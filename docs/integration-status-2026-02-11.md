...
- Единая тема письма для любых заказов (платных/бесплатных):
...
### Бесплатный билет (админка)
- Страница: `/admin`.
- UI: аккордеон `Бесплатный билет`.
- Кнопка `Выдать бесплатный билет`:
  - создает заказ в БД со стоимостью `0`,
  - отправляет гостю стандартное письмо с билетом.
- Кнопка `Скачать PDF`:
  - формирует локальное скачивание билета без отправки email.
