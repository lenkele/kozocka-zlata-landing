      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 py-14 md:grid-cols-[1.15fr_.85fr] md:px-7 md:py-16">
        <div>
          ...
          <div className="space-y-4">
            <TextPanel>
              Мы приезжаем с целым маленьким миром в паре чемоданов: куклами и декорациями, светом, звуком и живой музыкой.
              <br />
            ...
            <TextPanel>
              Куклы, тени, проекции, песни, скрипка и гитара. Сказки, в которых детям достаются приключения и чудеса, а взрослым - смех и печаль, которые
              прячутся между строк.
            </TextPanel>
          </div>
        </div>
      ...
      <section id="about" className="mx-auto grid max-w-6xl gap-7 px-5 py-14 md:grid-cols-2 md:px-7">
        ...
        <div className="rounded-[18px] border border-[#f2c46b2e] bg-[#2f2418c7] px-6 py-6 md:px-7">
          ...
          <div className="grid gap-3.5 text-[17px] leading-6">
            <TeamMember name="Елена Шамис" role="автор проекта и сценариев, вокал, куклы" />
            <TeamMember name="Саша Лунякова" role="режиссер, художник, бутафор" />
            <TeamMember name="Саша Скворцова" role="скрипка, работа с куклами" />
